...
const About = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Kaushal Rana (@thekaushalrana)</h3>

      <p style={{ color: '#a1a1aa', fontSize: '1.2rem', lineHeight: '1.8', maxWidth: '600px', margin: '0 auto 30px auto' }}>
        <strong>Join the community and grow together!</strong> SKJunction: My Scalable Shopping Platform
      </p>

      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
        {/* <a href="https://theshivanshvasu.com" target="_blank" rel="noreferrer" style={socialBtnStyle}>🌐 Website</a> */}
        <a href="https://www.youtube.com/@kaushalkaushuuk0189" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(239, 68, 68, 0.2)', borderColor: '#ef4444', color: '#ef4444' }}>📺 YouTube</a>
        ...
        <a href="https://www.linkedin.com/in/kaushal-rana-1544bb240/" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(59, 130, 246, 0.2)', borderColor: '#3b82f6', color: '#3b82f6' }}>💼 LinkedIn</a>
